...
function ContactUs() {
    ...
    const callAbout = async () => {
        ...
        const response = await axios.get('http://localhost:3131/about', { headers }).then((res) => {
    ...
    const contactUs = async (e) => {
        ...
        const response = await axios.post('http://localhost:3131/contact', { name, email, phone, subject, message }, { headers }).then((res) => {
