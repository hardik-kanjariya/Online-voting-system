...
function Home() {
    ...
    const checkVoter = async () => {
        ...
        const response = await axios.get('http://localhost:3131/voter', { headers }).then((res) => {
        ...
        const response2 = await axios.get('http://localhost:3131/state', { headers }).then((res) => {
    ...
    const postData = async (e) => {
        ...
        if (regex.test(userData.voter)) {
            const token = Cookies.get('userData')
            const headers = { 'token': token };
            const response = await axios.post('http://localhost:3131/voter', userData, { headers }).then((res) => {
                setTimeout(() => {
